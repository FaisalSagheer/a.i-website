...
function AnotherHero() {
  ...
  return (
    <>
    <Section
      className="pt-[14.2rem] -mt-[5.25rem]"
      crosses
      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mt-[-3.875rem] md:mt-20 lg:mt-[8.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            From custom AI assistants to full-blown automation ecosystems — we help creators, coaches, and companies unlock next-level productivity, clarity, and scale.
          </p>
          <Button href="#" white>
            Book a Call
          </Button>
        ...
        <CompanyLogos className="hidden relative z-10 mt-60 lg:block" />
            <BottomLine />
    </Section>
                  </>
  )
